...
//   const lineRef = useRef(null);
//   const [expanded, setExpanded] = useState(false);
//   const [isAnimating, setIsAnimating] = useState(false); // 🚨 Prevent click spamming
...
//     window.addEventListener("resize", resizeHandler);
//     updateSizeVars();
//     requestAnimationFrame(updateSizeVars); // 🧠 Better than setTimeout
...
// const handleExpand = () => {
//   if (isAnimating || expanded || !containerRef.current) return;
...
//       // ⏱️ Animate paragraphs AFTER layout is stable
//       animateSplitTextLines();
//     },
//   });
...
//         type: "lines",
//         linesClass: styles.splitLine, // 👈 Add this class to style lines
//       });
...
//     // Kill current timeline if exists
//     tlRef.current?.kill();
...
//     tlRef.current = tl; // Track new timeline
//   };
...
//                 <div className={styles.titleSection}>
//                   <h2 className={styles.title}>
//                     <span ref={(el) => (fadeUpEls.current[1] = el)}>
//                       Entertaining
//                     </span>{" "}
//                     <span ref={(el) => (fadeUpEls.current[2] = el)}>Suite</span>
//                   </h2>
//                 </div>
...
//                     <p key={i} ref={(el) => (fadeUpEls.current[i + 2] = el)}>
//                       {i % 2 === 0
//                         ? "The residence features direct elevator entry to a grand receiving hall with white macauba stone flooring..."
//                         : "The corner south-facing kitchen offers stunning city skyline views, custom cabinetry designed by Studio Sofield..."}
//                     </p>
//                   ))} */}
//                   <p className={styles.splitText} ref={(el) => (fadeEls.current[1] = el)}>
//                     The residence features direct elevator entry to a grand
//                     receiving hall with white macauba stone flooring... The
//                     corner south-facing kitchen offers stunning city skyline
//                     views, custom cabinetry designed by Studio Sofield...
//                   </p>
